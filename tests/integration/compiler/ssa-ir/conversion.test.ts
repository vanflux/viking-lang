...
describe('SSA conversion tests', () => {
  it('Convert function 1 to SSA form', () => {
    ...
    const expectedSSA = `test_0(int a?, int b?):
_T0 = a0 + b0
c0 = _T0
d0 = 0
e0 = 1
...
test_1(int d?, int c?, int e?):
_T1 = d0 < 10
_T0 = _T1
BR.NZ _T0 test_2(c0, e0, d0) test_6(c0)

test_2(int c?, int e?, int d?):
_T0 = c0 + e0
c1 = _T0
_T2 = e0 < 5
_T1 = _T2
...
test_3(int e?, int c?, int d?):
_T0 = e0 + 1
e1 = _T0
BR.GO test_5(d0, c0, e1)

test_4(int e?, int c?, int d?):
_T0 = e0 + 2
e1 = _T0
_T1 = c0 + 1
c1 = _T1
