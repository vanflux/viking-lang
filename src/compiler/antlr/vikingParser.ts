	...
	public entry(): EntryContext {
		...
		try {
			...
			do {
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
			} while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << vikingParser.T__0) | (1 << vikingParser.T__2) | (1 << vikingParser.T__3) | (1 << vikingParser.T__5) | (1 << vikingParser.T__6) | (1 << vikingParser.T__12) | (1 << vikingParser.ID) | (1 << vikingParser.DIGITS))) !== 0));
			}
		}
		catch (re) {
